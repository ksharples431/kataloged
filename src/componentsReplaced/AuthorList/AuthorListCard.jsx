...
const DesktopAuthorListCard = ({ author }) => {
  ...
  return (
    <AuthorCardWrapper>
      <LinkWrapper to={`/authors/${encodeURIComponent(author.author)}`}>
...
DesktopAuthorListCard.propTypes = {
...
export default DesktopAuthorListCard;