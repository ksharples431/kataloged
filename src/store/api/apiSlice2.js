  ...
  endpoints: (builder) => ({
    ...
    getBooks: builder.query({
      ...
      transformResponse: (response) => {
        ...
        console.log('Transformed Books:', transformedData);
    ...
    getBookById: builder.query({
      ...
      transformResponse: (response) => {
        ...
        console.log('Transformed Book By ID:', transformedData);
        return transformedData;
      },
    ...
    getUserBooks: builder.query({
      ...
      transformResponse: (response) => {
        const transformedData = {
          items: response.userBooks.map((book) => ({
            id: book.ubid,
            name: book.title,
            imagePath: book.imagePath || '/placeholder-book.jpg',
            secondaryText: book.author,
          })),
          type: 'book',
        };
        console.log('Transformed User Books:', transformedData);
        return transformedData;
      },
    ...
    getUserBookById: builder.query({
      ...
      transformResponse: (response) => {
          ...
          items: [
            {
              ...
              genre: book.genre,
              isbn: book.isbn,
              // ... any other fields you need for user books
              status: book.status,
              rating: book.rating,
        ...
        console.log('Transformed User Book By ID:', transformedData);
        return transformedData;
      },
