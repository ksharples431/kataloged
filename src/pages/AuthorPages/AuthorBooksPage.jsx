...
import { useAuthorBooks } from './authorHooks/useAuthors';
...
const AuthorBooksPage = () => {
  ...
  const { books, authorName, isLoading, isError, error } = useAuthorBooks({
    sortBy,
    order,
  });
  ...
  return (
    <Box>
      ...
      {books && books.length > 0 ? (
        ...
        <Typography>No books available for this author.</Typography>
      )}
      <Snackbar
        open={snackbar.open}
